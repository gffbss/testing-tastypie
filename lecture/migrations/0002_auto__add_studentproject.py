...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lecture_studentproject', (
            ...
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='students_projects', to=orm['lecture.Student'])),
        ))
    ...
    models = {
        ...
        u'lecture.studentproject': {
            ...
            'student': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'students_projects'", 'to': u"orm['lecture.Student']"})
        }
    }
